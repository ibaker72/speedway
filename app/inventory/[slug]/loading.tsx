        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="animate-pulse space-y-4">
              ...
              <div className="space-y-3 p-6 rounded-2xl border border-white/[0.06] bg-surface-1">
          ...
          <div className="lg:col-span-2">
            <div className="rounded-2xl border border-white/[0.08] bg-surface-2 p-6 md:p-7 animate-pulse space-y-4">
