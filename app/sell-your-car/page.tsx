...
export default function SellYourCarPage() {
  return (
    <SectionWrapper background="white">
      <SectionHeading
        title="Sell Your Car"
        subtitle="Want to sell without buying? We purchase vehicles directly — no trade required."
        as="h1"
      />
      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-zinc-600 mb-8 leading-relaxed">
          We buy cars, trucks, SUVs, and vans. Submit your vehicle details and
          we&apos;ll provide a competitive offer. The process is quick, transparent, and
          hassle-free. Get paid and walk away — it&apos;s that simple.
        </p>
