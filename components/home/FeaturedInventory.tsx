        ...
        {vehicles.map((vehicle, i) => (
          <AnimateIn key={vehicle.id} delay={i * 80} variant="up">
            <Link
              ...
              className="group rounded-2xl border border-zinc-200/80 bg-white overflow-hidden hover:shadow-xl hover:shadow-zinc-200/50 hover:border-zinc-300 transition-all duration-500 block"
            >
              {/* Image */}
