export function AutoDealerJsonLd() {
  const jsonLd = {
    ...
    description:
      "Full service New Jersey used car dealer offering quality cars, SUVs, trucks, and vans with easy financing options.",
    ...
    priceRange: "$$",
    sameAs: ["https://www.facebook.com/speedwaynj/"],
  };
