...
export function PaymentCalculator({ price, defaultPayment }: PaymentCalculatorProps) {
  ...
  return (
    <div>
      ...
      {open && (
        <div className="mt-3 p-4 bg-white/3 border border-white/6 rounded-xl space-y-4 animate-[fadeIn_0.2s_ease-out]">
          <div>
            ...
            <input
              ...
              className="w-full h-1.5 bg-white/8 rounded-full appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-4 [&::-webkit-slider-thumb]:h-4 [&::-webkit-slider-thumb]:bg-accent [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:cursor-pointer"
            />
          </div>
          <div>
