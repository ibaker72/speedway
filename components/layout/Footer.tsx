  ...
  return (
    <footer className="bg-[#0A0A0A] text-zinc-400 pb-20 lg:pb-0">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
        ...
        {/* Service Areas */}
        <div className="border-t border-white/4 py-6">
        ...
        <div className="border-t border-white/4 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-600">
          <p>
        ...
        <div className="border-t border-white/3 py-4 text-center">
