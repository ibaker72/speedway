...
export function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-[80] p-4 sm:p-5">
      <div className="mx-auto max-w-3xl rounded-2xl border border-white/[0.08] bg-[#111111]/95 backdrop-blur-md px-5 py-4 sm:px-6 sm:py-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
